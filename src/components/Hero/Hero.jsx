  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center px-4 md:px-6">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-white-400 mb-8">Software Developer · Join me for a cosmic tour!</p>
<a href="#contact"><button
  className="cursor-pointer relative bg-white/10 py-2 rounded-full min-w-[8.5rem] min-h-[2.92rem] group max-w-full flex items-center justify-start hover:bg-amber-500 transition-all duration-[0.8s] ease-[cubic-bezier(0.510,0.026,0.368,1.016)] shadow-[inset_1px_2px_5px_#00000080] mx-auto"
>
  <div className="absolute flex px-1 py-0.5 justify-start items-center inset-0">
    ...
    ></div>
    <div
      className="rounded-full shrink-0 flex justify-center items-center shadow-[inset_1px_-1px_3px_0_black] h-full aspect-square bg-amber-500 transition-all duration-[1s] ease-[cubic-bezier(0.510,0.026,0.368,1.016)] group-hover:bg-black"
    >
      <div
